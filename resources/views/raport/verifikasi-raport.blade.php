                    ...
                    <div class="table-responsive">
                        <table class="table" >
                            ...
                            <tr>
                                ...
                                <td >X A TKJ</td>
                                <td style="color:#57B657"><strong>Terverifikasi<strong></td>
                                <td >
                                <div class="d-flex flex-row bd-highlight">
                                    <a href="" class="btn btn-disabled rounded-pill">Verifikasi</a>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td >MUHAMMAD GHAZY TANTRA MAULIA</td>
                                <td >X A TKJ</td>
                                <td style="color:#FF4747"><strong>Belum Terverifikasi<strong></td>
                                <td >
                                <div class="d-flex flex-row bd-highlight">
                                    <a href="/raport/verifikasi-raport/deskripsi" class="btn btn-detail rounded-pill">Verifikasi</a>
                                    </div>
                                </td>
                            </tr>
