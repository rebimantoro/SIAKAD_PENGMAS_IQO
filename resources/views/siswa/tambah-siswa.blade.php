                    ...
                    <div class="tab-content pt-2" id="borderedTabContent">
                        ...
                        <div class="tab-pane fade show active" id="bordered-siswa" role="tabpanel" aria-labelledby="siswa-tab">
                            ...
                            <div class="mb-5">                                              
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="nik_siswa" name="nik" required placeholder="Masukkan NIK" value={{old('nik')}}>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="akte">No. Akte</label>
                                        <input type="text" class="form-control" id="akte" required name="akte_siswa" placeholder="Masukkan No. Akte" value={{old('akte_siswa')}}>
                                    </div>
                                </div>
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        <label for="kk">No. KK</label>
                                        <input type="text" class="form-control" id="kk" name="kk_siswa" required placeholder="Masukkan No. KK" value={{old('kk_siswa')}}>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="nisn">NISN</label>
                                        <input type="text" class="form-control" id="nisn" required name="nisn_siswa" placeholder="Masukkan NISN" value={{old('nisn_siswa')}}>
                                    </div>
                                </div>
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        <label for="nama-lengkap">Nama Lengkap</label>
                                        <input type="text" class="form-control" id="nama-lengkap" name="nama_lengkap" required placeholder="Masukkan Nama Lengkap" value={{old('nama_lengkap')}}>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="nama-panggilan">Nama Panggilan</label>
                                        <input type="text" class="form-control" id="nama-panggilan" required name="nama_panggilan" placeholder="Masukkan Nama Panggilan" value={{old('nama_panggilan')}}>
                                    </div>
                                </div>
                                {{-- upload skhun pdf --}}
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="file" class="form-control" id="skhun" name="skhun_siswa" required placeholder="Masukkan SKHUN">
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="ijazah">Ijazah</label>
                                        <input type="file" class="form-control" id="ijazah" name="ijazah_siswa" required placeholder="Masukkan Ijazah">
                                    </div>
                                </div>
                                <div class="px-2 mb-3">
                                ...
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="tempat-lahir" required name="tempat_lahir" placeholder="Masukkan Tempat Lahir" value={{old('tempat_lahir')}}>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="tanggal-lahir">Tanggal Lahir</label>
                                        <input type="date" class="form-control" id="tanggal-lahir" required name="tanggal_lahir" value={{old('tanggal_lahir')}}>
                                    </div>
                                </div>
                                {{-- skip --}}
                                <div class="row px-2">
                                ...
                                <div class="pt-2 px-2 mb-2">
                                    ...
                                    <div class="input-group">
                                        <textarea type="text" class="form-control" id="bahasa" required name="bahasa" value={{old('bahasa')}}>
                                        </textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-5">                                              
                                ...
                                {{-- skip --}}
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="anak-ke" required name="anak_ke" placeholder="Isi Dengan Angka" value={{old('anak_ke')}}>
                                    </div>
                                    <div class="col-md-3 mb-2">
                                        <label for="jumlah-saudara">Jumlah Saudara</label>
                                        <input type="text" class="form-control" id="jumlah-saudara" required name="jumlah_saudara" placeholder="Isi Dengan Angka" value={{old('jumlah_saudara')}}>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-5">                                              
                                ...
                                <div class="row px-2 mb-2">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="date" class="form-control" id="tanggal-belajar" required name="tanggal_belajar" value={{old('tempat_belajar')}}>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end">
                                    <button class="btn btn-primary btn-block" style="margin-right:10px">Prev</button>
                                ...
                                <div class="mb-3">                                              
                                    <div class="row px-2 mb-2">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="text" class="form-control" id="blok" name="provinsi" required placeholder="Masukkan Provinsi" value={{old('provinsi')}}>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label for="kab-kota">Kabupaten/Kota</label>
                                            <input type="text" class="form-control" id="kab-kota" required name="kab_kota" placeholder="Masukkan Kabupatne/Kota" value={{old('kab_kota')}}>
                                        </div>
                                    </div>
                                    <div class="row px-2 mb-2">
                                        <div class="col-md-6 mb-2">
                                            <label for="kecamatan">Kecamatan</label>
                                            <input type="text" class="form-control" id="kecamatan" name="kecamatan" required placeholder="Masukkan Kecamatan" value={{old('kecamatan')}}>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label for="desa-kel">Desa/Kelurahan</label>
                                            <input type="text" class="form-control" id="desa-kel" required name="desa_kel" placeholder="Masukkan Desa/Kelurahan" value={{old('desa_kel')}}>
                                        </div>
                                    </div>
                                    <div class="row px-2 mb-2">
                                        <div class="col-md-6 mb-2">
                                            <label for="alamat">Alamat</label>
                                            <input type="text" class="form-control" id="alamat" name="alamat" required placeholder="Masukkan Alamat" value={{old('alamat')}}>
                                        </div>
                                        <div class="col-md-1 mb-2">
                                            <label for="rt">RT</label>
                                            <input type="text" class="form-control" id="rt" required name="rt" placeholder="000" value={{old('rt')}}>
                                        </div>
                                        <div class="col-md-1 mb-2">
                                            <label for="rw">RW</label>
                                            <input type="text" class="form-control" id="rw" required name="rw" placeholder="000" value={{old('rw')}}>
                                        </div>
                                        <div class="col-md-4 mb-2">
                                            <label for="kode-pos">Kode Pos</label>
                                            <input type="text" class="form-control" id="kode-pos" required name="kode_pos" placeholder="Masukkan Kode Pos" value={{old('kode_pos')}}>
                                        </div>
                                    </div>
                                    <div class="row px-2 mb-2">
                                        <div class="col-md-6 mb-2">
                                            <label for="no_telp">Nomor Telepon</label>
                                            <input type="text" class="form-control" id="no_telp" name="no_telp" required placeholder="Masukkan Nomor Telepon" value={{old('no_telp')}}>
                                            </div>
                                        <div class="col-md-6 mb-2">
                                            <label for="email">Email</label>
                                            <input type="text" class="form-control" id="email" required name="email" placeholder="Masukkan Email" value={{old('email')}}>
                                        </div>
                                    </div>
                                    <div class="row px-2 mb-2">
                                        <div class="col-md-6 mb-2">
                                            <label for="no_telp">Jarak Ke Sekolah</label>
                                            <input type="text" class="form-control" id="no_telp" name="jarak" required placeholder="Masukkan Jarak" value={{old('jarak')}}>
                                        </div>
                                        {{-- skip --}}
                                        <div class="col-md-6 mb-2">
                                    ...
                                    <div class="row px-2 mb-2">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <input type="text" class="form-control" id="waktu-tempuh-jam" name="waktu_tempuh_jam" required placeholder="00 Jam" value={{old('waktu_tempuh_jam')}}>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <input type="text" class="form-control" id="waktu-tempuh-menit" required name="waktu_tempuh_menit" placeholder="00 Ment" value={{old('waktu_tempuh_menit')}}>
                                        </div>
                                    </div>
                                </div>
                            <div class="d-flex justify-content-end">
                            ...
                            {{-- skip --}}
                                <div class="mb-3">                                              
                                    ...
                                    <div class="pt-2 px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <textarea type="text" class="form-control" id="penyakit-kronis" required name="penyakit_kronis" value={{old('penyakit_kronis')}}>
                                            </textarea>
                                        </div>
                                    </div>
                                    <div class="pt-2 px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <textarea type="text" class="form-control" id="kelainan" required name="kelainan" value={{old('kelainan')}}>
                                            </textarea>
                                        </div>
                                    </div>
                                    <div class="px-2 mb-2">
                                    ...
                                    <div class="row px-2 mb-2">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="text" class="form-control" id="tb" required name="tb" placeholder="Masukkan Tinggi Badan (dalam cm)" value={{old('tb')}}>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label for="bb">Berat Badan</label>
                                            <input type="text" class="form-control" id="bb" required name="bb" placeholder="Masukkan Berat Badan (dalam kg)" value={{old('bb')}}> 
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end">
                                ...
                                <div class="mb-5">  
                                    <div class="row px-2 mb-2">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="text" class="form-control" id="nama-tk" required name="nama_tk" placeholder="Masukkan Sekolah Asal" value={{old('nama_tk')}}> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="row px-2 mb-2">
                                        <div class="col-md-6 ">
                                            ...
                                            <input type="date" class="form-control" id="tanggal-ijazah-tk" required name="tanggal_ijazah_tk" value={{old('tanggal_ijazah_tk')}}>
                                        </div>
                                        <div class="col-md-6 ">
                                            <label for="ijazah-tk">No. Ijazah</label>
                                            <input type="text" class="form-control" id="ijazah-tk" required name="ijazah_tk" placeholder="Masukkan Nomor Ijazah" value={{old('ijazah_tk')}}>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="pt-2 px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="ujian-tk" required name="ujian_tk" placeholder="Masukkan No. Ujian Sebelumnya" value={{old('ujian_tk')}}> 
                                        </div>
                                    </div>
                                ...
                                <div class="mb-5">  
                                    <div class="row px-2 mb-2">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="text" class="form-control" id="nama-sd" required name="nama_sd" placeholder="Masukkan Sekolah Asal" value={{old('nama_sd')}}> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="row px-2 mb-2">
                                        <div class="col-md-6 ">
                                            ...
                                            <input type="date" class="form-control" id="tanggal-ijazah-sd" required name="tanggal_ijazah_sd" value={{old('tanggal_ijazah_sd')}}>
                                        </div>
                                        <div class="col-md-6 ">
                                            <label for="ijazah-sd">No. Ijazah</label>
                                            <input type="text" class="form-control" id="ijazah-sd" required name="ijazah-sd" placeholder="Masukkan Nomor Ijazah" value={{old('ijazah-sd')}}>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="pt-2 px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="ujian-sd" required name="ujian_sd" placeholder="Masukkan No. Ujian Sebelumnya" value={{old('ujian_sd')}}> 
                                        </div>
                                    </div>
                                ...
                                <div class="mb-5">  
                                    <div class="row px-2 mb-2">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="text" class="form-control" id="nama-smp" required name="nama_smp" placeholder="Masukkan Sekolah Asal" value={{old('nama_smp')}}> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="row px-2 mb-2">
                                        <div class="col-md-6 ">
                                            ...
                                            <input type="date" class="form-control" id="tanggal-ijazah-smp" required name="tanggal_ijazah_smp" value={{old('tanggal_ijazah_smp')}}>
                                        </div>
                                        <div class="col-md-6 ">
                                            <label for="ijazah-smp">No. Ijazah</label>
                                            <input type="text" class="form-control" id="ijazah-smp" required name="ijazah_smp" placeholder="Masukkan Nomor Ijazah" value={{old('ijazah_smp')}}>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="pt-2 px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="ujian-smp" required name="ujian_smp" placeholder="Masukkan No. Ujian Sebelumnya" value={{old('ujian_smp')}}> 
                                        </div>
                                    </div>
                            ...
                            <br><br>
                                ...
                                {{-- skip --}}
                                    ...
                                    <div class="pt-2 px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <textarea type="text" class="form-control" id="alasan-pindah" required name="alasan_pindah" value={{old('alasan_pindah')}}>
                                            </textarea>
                                        </div>
                                    </div>
                                    <div class="pt-2 px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="no-surat-pindah" required name="no_surat_pindah" value={{old('no_surat_pindah')}}> 
                                        </div>
                                    </div>
                                    <div class="pt-2 px-2 mb-2">
                                        <label for="sekolah-asal">Nama Sekolah Asal</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="sekolah-asal" required name="sekolah_asal" value={{old('sekolah_asal')}}> 
                                        </div>
                                    </div>
                                    <div class="pt-2 px-2 mb-2">
                                        <label for="alamat-sekolah-asal">Alasan Dipindahkan</label>
                                        <div class="input-group">
                                            <textarea type="text" class="form-control" id="alasan-pindahalamat-sekolah-asal" required name="alamat_sekolah_asal" value={{old('alamat_sekolah_asal')}}>
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br><br>
                                <div class="mb-5">                                              
                                    <div class="px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="nama-ayah" required name="nama_ayah" placeholder="Masukkan Nama Ayah" value={{old('nama_ayah')}}> 
                                        </div>
                                    </div>
                                    <div class="pt-2 px-2 mb-2">
                                        <label for="nik-ayah">NIK Ayah</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="nik-ayah" required name="nik_ayah" placeholder="Masukkan NIK Ayah" value={{old('nik_ayah')}}> 
                                        </div>
                                    </div>
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        <label for="tempat-lahir-ayah">Tempat</label>
                                        <input type="text" class="form-control" id="tempat-lahir-ayah" required name="tempat_lahir_ayah" placeholder="Masukkan Tempat Lahir Ayah" value={{old('tempat_lahir_ayah')}}>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="tanggal-lahir-ayah">Tanggal Lahir</label>
                                        <input type="date" class="form-control" id="tanggal-lahir-ayah" required name="tanggal_lahir_ayah" value={{old('tanggal_lahir_ayah')}}>
                                    </div>
                                </div>
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        <label for="agama">Agama</label>
                                        <select class="form-select" name="agama_ayah" aria-label="Pilih Agama">
                                        <option selected>-- Pilih Agama --</option>
                                        <option value="islam">Islam</option>
                                        <option value="protestan">Kristen Protestan</option>
                                        <option value="katholik">Kristen Katholik</option>
                                ...
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="telp-ayah" required name="telp_ayah" placeholder="*)Wajib Memassukkan nomor telepon Aktif" value={{old('telp_ayah')}}>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="email">Email</label>
                                        <input type="text" class="form-control" id="email" required name="email_ayah" placeholder="Masukkan Email Ayah" value={{old('email_ayah')}}>
                                    </div>
                                </div>
                                <div class="row px-2 mb-2">
                                {{-- skip --}}
                                ...
                                {{-- skip --}}
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="pendidikan-ayah" required name="lembaga_pendidikan_ayah" placeholder="Masukkan Nama Lembaga Pendidikan" value={{old('lembaga_pendidikan_ayah')}}>
                                    </div>
                                </div>
                                <div class="row px-2 mb-2">
                                <div class="col-md-6 mb-2">
                                        <label for="profesi-ayah">Profesi</label>
                                        <input type="text" class="form-control" id="profesi-ayah" required name="profesi_ayah" placeholder="Masukkan Profesi" value={{old('profesi_ayah')}}>
                                    </div>
                                    {{-- skip --}}
                                    <div class="col-md-6 mb-2">
                                    ...
                                    <div class="px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="nrp-ayah" name="nrp_ayah" placeholder="*) Isikan Jika Staff Sekolah/Yayasan" value={{old('nrp_ayah')}}> 
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br><br>
                                <div class="mb-5">                                              
                                    <div class="px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="nama-ibu" required name="nama_ibu" placeholder="Masukkan Nama ibu" value={{old('nama_ibu')}}> 
                                        </div>
                                    </div>
                                    <div class="pt-2 px-2 mb-2">
                                        <label for="nik-ibu">NIK Ibu</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="nik-ibu" required name="nik_ibu" placeholder="Masukkan NIK ibu" value={{old('nik_ibu')}}> 
                                        </div>
                                    </div>
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        <label for="tempat-lahir-ibu">Tempat</label>
                                        <input type="text" class="form-control" id="tempat-lahir-ibu" required name="tempat_lahir_ibu" placeholder="Masukkan Tempat Lahir ibu" value={{old('tempat_lahir_ibu')}}>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="tanggal-lahir-ibu">Tanggal Lahir</label>
                                        <input type="date" class="form-control" id="tanggal-lahir-ibu" required name="tanggal_lahir_ibu" value={{old('tanggal_lahir_ibu')}}>
                                    </div>
                                </div>
                                <div class="row px-2 mb-2">
                                {{-- skip --}}
                                ...
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="telp-ibu" required name="telp_ibu" placeholder="*)Wajib Memassukkan nomor telepon Aktif" value={{old('telp_ibu')}}>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="email">Email</label>
                                        <input type="text" class="form-control" id="email" required name="email_ibu" placeholder="Masukkan Email ibu" value={{old('email_ibu')}}>
                                    </div>
                                </div>
                                <div class="row px-2 mb-2">
                                {{-- skip --}}
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <select name="wn_ibu" class="form-select" aria-label="Pilih Warga Negara">
                                        <option selected>-- Pilih Warga Negara --</option>
                                        <option value="wni">WNI</option>
                                        <option value="wna">WNA</option>
                                        </select>
                                    ...
                                    {{-- skip --}}
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <select name="status_hidup_ibu" class="form-select" aria-label="Pilih Status">
                                            <option selected>-- Pilih Status --</option>
                                            <option value="hidup">Hidup</option>
                                            <option value="meninggal">Meninggal Dunia</option>
                                        </select>
                                ...
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <select name="pendidikan_ibu" class="form-select" aria-label="Pilih Pendidikan Terakhir">
                                        <option selected>-- Pilih Pendidikan Terakhir --</option>
                                        <option value="d1">D1</option>
                                        <option value="d2">D2</option>
                                        <option value="d3">D3</option>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="pendidikan-ibu" required name="lembaga_pendidikan_ibu" placeholder="Masukkan Nama Lembaga Pendidikan" value={{old('lembaga_pendidikan_ibu')}}> 
                                    </div>
                                </div>
                                <div class="row px-2 mb-2">
                                <div class="col-md-6 mb-2">
                                        <label for="profesi-ibu">Profesi</label>
                                        <input type="text" class="form-control" id="profesi-ibu" required name="profesi_ibu" placeholder="Masukkan Profesi" value={{old('profesi_ibu')}}>
                                    </div>
                                    {{-- skip --}}
                                    <div class="col-md-6 mb-2">
                                    ...
                                    <div class="px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="nrp-ibu" name="nrp_ibu" placeholder="*) Isikan Jika Staff Sekolah/Yayasan" value={{old('nrp_ibu')}}> 
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br><br>
                                <div class="mb-4">                                              
                                    <div class="px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="nama-wali" required name="nama_wali" placeholder="Masukkan Nama wali" value={{old('nama_wali')}}> 
                                        </div>
                                    </div>
                                    <div class="pt-2 px-2 mb-2">
                                        <label for="nik-wali">NIK Wali</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="nik-wali" required name="nik_wali" placeholder="Masukkan NIK wali" value={{old('nik_wali')}}> 
                                        </div>
                                    </div>
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        <label for="tempat-lahir-wali">Tempat</label>
                                        <input type="text" class="form-control" id="tempat-lahir-wali" required name="tempat_lahir_wali" placeholder="Masukkan Tempat Lahir wali" value={{old('tempat_lahir_wali')}}>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="tanggal-lahir-wali">Tanggal Lahir</label>
                                        <input type="date" class="form-control" id="tanggal-lahir-wali" required name="tanggal_lahir_wali" value={{old('tanggal_lahir_wali')}}>
                                    </div>
                                </div>
                                <div class="row px-2 mb-2">
                                {{-- skip --}}
                                ...
                                <div class="row px-2 mb-2">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="telp-wali" required name="telp_wali" placeholder="*)Wajib Memassukkan nomor telepon Aktif" value={{old('telp-wali')}}>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="email">Email</label>
                                        <input type="text" class="form-control" id="email" required name="email_wali" placeholder="Masukkan Email wali" value={{old('email_wali')}}>
                                    </div>
                                </div>
                                <div class="row px-2 mb-2">
                                {{-- skip --}}
                                ...
                                {{-- skip --}}
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="pendidikan-wali" required name="lembaga_pendidikan_wali" placeholder="Masukkan Nama Lembaga Pendidikan" value={{old('lembaga_pendidikan_wali')}}>
                                    </div>
                                </div>
                                <div class="row px-2 mb-2">
                                <div class="col-md-6 mb-2">
                                        <label for="profesi-wali">Profesi</label>
                                        <input type="text" class="form-control" id="profesi-wali" required name="profesi_wali" placeholder="Masukkan Profesi" value={{old('profesi_wali')}}>
                                    </div>
                                    {{-- skip --}}
                                    <div class="col-md-6 mb-2">
                                    ...
                                    <div class="px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="nrp-wali" name="nrp_wali" placeholder="*) Isikan Jika Staff Sekolah/Yayasan" value={{old('nrp_wali')}}> 
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end">
                            ...
                            <br><br>
                                <div class="mb-3">                                              
                                    <div class="px-2 mb-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="kesenian" required name="kesenian" placeholder="Masukkan Hobi Kesenian" value={{old('kesenian')}}> 
                                        </div>
                                    </div>
                                    <div class="pt-2 px-2 mb-2">
                                        <label for="olahraga">Hobi Olahraga</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="olahraga" required name="olahraga" placeholder="Masukkan Hobi Olahraga" value={{old('olahraga')}}> 
                                        </div>
                                    </div>
                                    <div class="pt-2 px-2 mb-2">
                                        <label for="organisasi">Organisasi</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="organisasi" required name="organisasi"placeholder="Masukkan Organisasi" value={{old('organisasi')}}> 
                                        </div>
                                    </div>
                                    <div class="pt-2 px-2 mb-2">
                                        <label for="hobi-lain">Lainnya</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="hobi-lain" required name="hobi_lain" placeholder="Masukkan Hobi Lainnya" value={{old('hobi_lain')}}> 
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end">
                                ...
                                {{-- skip --}}
                                    ...
                                    <div class="row px-2">
                                        <div class="col-md-6 ">
                                            ...
                                            <input type="text" class="form-control" id="kode-bank" required name="kode_bank" placeholder="*) Untuk Penerima PIP" value={{old('kode_bank')}}>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label for="rekening">Nomor Rekening</label>
                                            <input type="text" class="form-control" id="rekening" required name="no_rekening" placeholder="*) Untuk Penerima PIP" value={{old('no_rekening')}}>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="pt-2 px-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="rekeningan" required name="nama_rekening" placeholder="*) Untuk Penerima PIP" value={{old('nama_rekenig')}}>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    {{-- skip --}}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="no-kps" required name="no_kps" placeholder="*) Jika Ya Isi No. KPS (Kartu Perlindungan Sosial)" value={{old('no_kps')}}>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    {{-- skip --}}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="no-kip" required name="no_kip" placeholder="*) Jika Ya Isi No. KIP (Kartu Indonesia Pintar)" value={{old('no_kip')}}>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row px-2 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="nama-kip" required name="nama_kip" placeholder="*) Jika Ya Isi Nama Penerima KIP" value={{old('nama_kip')}}>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="no-kks">No. KKS</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="no-kks" required name="no_kks" placeholder="*) Jika Memiliki KKS (Kartu Keluarga Sejahtera)" value={{old('no_kks')}}>
                                            </div>
                                        </div>
                                    </div>
                                </div>
