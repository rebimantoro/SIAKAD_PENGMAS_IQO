                  ...
                  <div class="card-body">
                      ...
                      <form action="{{ route('register.post') }}" method="POST">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="role" class="custom-select" id="role" required autofocus>
                                    <option value="1">Kepala Sekolah</option>
                                    <option value="1">Wakil Kepala Sekolah</option>
                                    <option value="2">Bagian Kepegawaian</option>
                                    <option value="3">Bagian Kurikulum</option>
                                    <option value="4">Bagian Kesiswaan</option>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="jabatan" class="form-control" name="jabatan" required autofocus>
