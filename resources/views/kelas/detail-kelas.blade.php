        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <h1 class="fw-bolder mt-2 ps-2" style="color:#367FA9; float:left; font-size:20px;">Detail Data Kelas</h1>
                    ...
                    <div class="tab-content pt-2" id="borderedTabContent">
                        ...
                        <div class="row px-2 mb-3">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <option >-- Pilih Tingkat/Grade Kelas --</option>
                                    <option value="x">X</option>
                                    <option selected value="xi">XI</option>
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <option selected value="k13">K13</option>
                            ...
                            <div class="row px-2 mb-3">
                                <div class="col-md-6 ">
                                    ...
                                    <option selected value="tkj">TKJ</option>
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <option selected value="21/22">2021/2022</option>
                            ...
                            <div class="row px-2 mb-3">
                                <div class="col-md-12 ">
                                    ...
                                    <option selected value="abdullah">0057 - Abdullah Musa, S.Pd</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row px-2 mb-3">
                                <div class="col-md-6 ">
                                    ...
                                    <input type="text" class="form-control" id="nama-kelas" value="XII TKJ 1" required name="nama-kelas" placeholder="Masukkan Nama Kelas">
                                </div>
                                <div class="col-md-6 ">
                                    <label for="nama-lain">Nama Lain Kelas *)Umar Bin Khottob</label>
                                    <input type="text" class="form-control" value="Bilal Bin Rabbah" id="nama-lain" required name="nama-lain" placeholder="Masukkan Nama Lain Kelas">
                                </div>
                            </div>
                            ...
                            <div class="row px-2 mb-3">
                                <div class="col-md-6 ">
                                    ...
                                    <input type="text" class="form-control" id="kapasitas" value="18" required name="kapasitas" placeholder="Masukkan Kapasitas Kelas">
                                </div>
                            </div>
