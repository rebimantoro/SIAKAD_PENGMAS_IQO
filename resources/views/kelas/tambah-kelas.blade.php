            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header pt-3">
                        <h1 class="fw-bolder mt-2 ps-2" style="color:#367FA9; float:left; font-size:20px;">Tambah Data Kelas
                        </h1>
                                ...
                                <form>
                                    <div class="row px-2 mb-3">
                                        ...
                                        <div class="col-md-6 ">
                                            ...
                                            <select name="tingkat_kelas" class="form-select" aria-label="Pilih Kelas">
                                        ...
                                        <div class="col-md-6 ">
                                            ...
                                            <select name="kurikulum" class="form-select" aria-label="Pilih Kurikulum">
