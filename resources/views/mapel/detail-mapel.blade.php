...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Detail Mapel</li>
        </ol>
    </nav>
</div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <h1 class="fw-bolder mt-2 ps-2" style="color:#367FA9; float:left; font-size:20px;">Detail Mata Pelajaran</h1>
                        ...
                        <form>
                            ...
                            <div class="row px-2 mb-3">
                                <div class="col-md-6 ">
                                    ...
                                    <input type="text" class="form-control" id="nama-mapel" value="Matematika" required name="nama-mapel" placeholder="Masukkan Nama Mata Pelajaran">
                                </div>
                                <div class="col-md-6">
                                    <label for="kelompok">Kelompok Mata Pelajaran</label>
                                    <select class="form-select" aria-label="Pilih Kelompok Mata Pelajaran">
                                    <option >-- Pilih Kelompok Mata Pelajaran --</option>
                                    <option selected value="nasional">Muatan Nasional</option>
