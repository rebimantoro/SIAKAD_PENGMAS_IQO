...
@section('content')
    ...
    @endif
    {{-- {{$mapel}} --}}
    <form method="POST" action="{{ route('plotting-mapel') }}" autocomplete="off" enctype="multipart/form-data">
        <!-- tabel -->
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header pt-3">
                            <h1 class="fw-bolder mt-2 ps-2" style="color:#367FA9; float:left; font-size:20px;">Data Mapel
                            </h1>
                            <br><br>
                                            ...
                                            <td>
                                                <div>
                                                    <select name="guru" class="form-select" aria-label="Pilih Guru">
                                                        ...
                                                        @foreach ($guru as $gr)
                                                            <option value="{{ $gr->id }}">{{ $gr->nama_pegawai }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
